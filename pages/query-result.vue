...
.orb-1 {
  ...
  top: -120px;
  left: -80px;
  animation: orbFloat1 16s cubic-bezier(0.45, 0.05, 0.55, 0.95) infinite,
...
.orb-2 {
  ...
  top: 30%;
  right: -60px;
  animation: orbFloat2 20s cubic-bezier(0.25, 0.46, 0.45, 0.94) infinite,
...
.orb-3 {
  ...
  bottom: -80px;
  left: -40px;
  animation: orbFloat3 18s cubic-bezier(0.55, 0.085, 0.68, 0.53) infinite,
